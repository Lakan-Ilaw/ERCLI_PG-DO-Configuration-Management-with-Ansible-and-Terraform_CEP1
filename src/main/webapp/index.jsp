<div class="header-section">
  ...
  <div class="container text-center intro-text">
    <div class="row">
      <div class="col-md-12">
        <h1>Hello, I'm Elmer Lakan-Ilaw.</h1>
        <p>Software Engineer, Electronics & Communications Engineer, DevOps.</p>
      </div>
      <div class="col-md-12">
        <p class="intro-btns">
          <a class="btn btn-info btn-lg" href="https://github.com/Lakan-Ilaw" role="button" target="_blank"><i class="fa fa-twitter fa-fw"></i>Simplilearn</a>
          <a class="btn btn-success btn-lg" href="https://github.com/Lakan-Ilaw" role="button" target="_blank"><i class="fa fa-fire fa-lg fa-fw"></i>Caltech</a>
          <a class="btn btn-default btn-lg" href="https://github.com/Lakan-Ilaw" role="button" target="_blank"><i class="fa fa-github fa-lg fa-fw"></i>Github</a>
          </p>
      </div>
    </div>
  </div>
...
<div id="about">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
        <p>CI/CD Deployment Using Ansible CM Tool</p>
        <p>You are a DevOps engineer at XYZ Ltd. Your company is working on a Java application and wants to automate WAR file artifact deployment so that they don’t have to perform WAR deployment on Tomcat/Jetty web containers. Automate Ansible integration with Jenkins CI server so that we can run and execute playbooks to deploy custom WAR files to a web container and then perform restart for the web container.</p>
          
      </div>
      <div class="col-md-4">  
        <p>Configure Jenkins server as Ansible provisioning machine</p>
        <p>Install Ansible plugins in Jenkins CI server</p>
        <p>Prepare Ansible playbook to run Maven build on Jenkins CI server</p>
        <p>Prepare Ansible playbook to execute deployment steps on the remote web container with restart of the web container post deployment</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-md-4">
        <div class="thumbnail">
          ...
          <div class="">
            <h3 class="portfolio-title">PROPS</h3>
